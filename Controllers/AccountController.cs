...
namespace kidyx.com.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    return RedirectToAction("Profiledetails_Create", "Home");
                }
                AddErrors(result);
            }
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> RegisterRoles(RegisterViewModel model,ApplicationUser user)
        {context = new ApplicationDbContext();
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> deleteRoles(RegisterViewModel model, ApplicationUser user)
        {
            context = new ApplicationDbContext();
            var userID = context.Users.Where(i => i.UserName == user.UserName).Select(s => s.Id);
            string updateId = "";
